...
- July 8, 2025. **STANDARDIZED BOTTOM PADDING ACROSS ALL PAGES**: Fixed bottom page spacing inconsistencies to align properly with bottom navigation menu: updated FinancePage and SimulatorsPage from pb-20 to pb-24, then fine-tuned FinancePage to pb-8 for optimal spacing, increased HomePage padding to pb-32 due to conditional achievement badge visibility, ensured optimal spacing across all main pages preventing content cutoff while eliminating excessive gaps above bottom navigation menu.
