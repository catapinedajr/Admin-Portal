...
- July 8, 2025. **STANDARDIZED BOTTOM PADDING ACROSS ALL PAGES**: Fixed bottom page spacing inconsistencies to align properly with bottom navigation menu: updated FinancePage and SimulatorsPage from pb-20 to pb-24, ensured consistent spacing across all main pages (HomePage, LearnPage, MorePage, CommunityPage, AccountPage), improved user experience by preventing content from being cut off by bottom navigation, aligned all page content to end cleanly above the 72px navigation menu height.
