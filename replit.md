...
- July 8, 2025. **STANDARDIZED BOTTOM PADDING ACROSS ALL PAGES**: Fixed bottom page spacing inconsistencies to align properly with bottom navigation menu: updated FinancePage and SimulatorsPage from pb-20 to pb-24, ensured consistent spacing across all main pages, additionally increased HomePage padding from pb-24 to pb-32 due to conditional achievement badge visibility causing bottom row cutoff, improved user experience by preventing content from being cut off by bottom navigation, aligned all page content to end cleanly above the 72px navigation menu height.
