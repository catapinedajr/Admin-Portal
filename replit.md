...
- July 8, 2025. **STANDARDIZED BOTTOM PADDING ACROSS ALL PAGES**: Fixed bottom page spacing inconsistencies to align properly with bottom navigation menu: updated FinancePage and SimulatorsPage from pb-20 to pb-24, then adjusted FinancePage to pb-16 to reduce excessive gap, increased HomePage padding to pb-32 due to conditional achievement badge visibility, ensured optimal spacing across all main pages preventing content cutoff while avoiding unnecessary large gaps above bottom navigation menu.
