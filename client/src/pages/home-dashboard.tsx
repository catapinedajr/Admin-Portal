              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-orange-500 rounded-lg flex items-center justify-center">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-white">
                    {/* Lightbulb outline */}
                    <path d="M9 21h6M12 3a6 6 0 0 1 6 6c0 2-1 3.5-3 4.5V17a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-3.5C7 12.5 6 11 6 9a6 6 0 0 1 6-6Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    {/* Bitcoin ₿ symbol inside the bulb */}
                    <text x="12" y="11" textAnchor="middle" className="text-xs font-bold fill-current">₿</text>
                  </svg>
                </div>
                <div>
