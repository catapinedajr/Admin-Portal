...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6">
        ...
        {activeSection === "learn" && (
          <div className="space-y-6">
            ...
            {/* Temporary Learn content placeholder */}
            <div className="text-center">
              <Card className="bg-zinc-900 border-zinc-800">
                <CardContent className="p-6">
                  <h2 className="text-xl font-bold text-white mb-4">
                    Learn Section - Restored
                  </h2>
        ...
        {activeSection === "money" && (
          <div className="space-y-8">
            {/* Finance content starts here */}
            <div className="text-center">
              <h2 className="text-3xl font-bold text-white mb-4">Why Bitcoin?</h2>
              <p className="text-xl text-zinc-300 max-w-3xl mx-auto">
                Traditional money is broken. Here's how Bitcoin fixes the fundamental problems with our current financial system.
              </p>
            </div>

            {/* Temporary placeholder while we fix the structure */}
            <Card className="bg-zinc-900 border-zinc-800">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-white mb-4">Finance Section - Restored</h3>
                <p className="text-zinc-400">
                  Finance section temporarily simplified for emergency cleanup.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        {activeSection === "simulators" && (
          <div className="space-y-8">
            <Card className="bg-zinc-900 border-zinc-800">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-white mb-4">Simulators Section - Restored</h3>
                <p className="text-zinc-400">
                  Simulators section temporarily simplified for emergency cleanup.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        {activeSection === "more" && (
          <div className="space-y-8">
            <Card className="bg-zinc-900 border-zinc-800">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-white mb-4">More Section - Restored</h3>
                <p className="text-zinc-400">
                  More section temporarily simplified for emergency cleanup.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="space-y-4">
              <p className="text-sm text-zinc-600">
                Enter your email to get notified when premium features launch.
              </p>
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 bg-black/95 backdrop-blur-sm border-t border-zinc-800 pb-safe">
        <div className="flex justify-around items-center h-16 max-w-md mx-auto px-4">
          <button
            ...
            className={`flex flex-col items-center gap-1 px-3 py-2 rounded-lg transition-colors ${
              activeSection === "home" ? "text-orange-400" : "text-zinc-400 hover:text-zinc-300"
            }`}
          >
