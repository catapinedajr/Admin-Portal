                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-white">Continue Journey</h3>
                        <p className="text-sm text-zinc-400">Day {currentDayIndex} • {dayMetadata?.title || 'Loading...'}</p>
                      </div>
                    </div>
                    
                    {dailyFacts && dailyFacts[0] && (
                      <div className="bg-zinc-800/50 rounded-lg p-4 border-l-2 border-orange-500">
                        <div className="text-sm font-medium text-orange-400 mb-2">Today's First Question:</div>
