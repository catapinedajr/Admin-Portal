...
import BankingFeesSimulator from "@/components/BankingFeesSimulator";
import { 
  Bitcoin, 
  Lightbulb, 
  BookOpen, 
  ...
  const markDayCompletedMutation = useMutation({
    ...
    onSuccess: (_, dayIndex) => {
      ...
      if (!completionNotificationsShown.has(dayIndex)) {
        setCompletionNotificationsShown(prev => {
      ...
      <main className="max-w-6xl mx-auto px-4 py-6">
        ...
        {activeSection === "more" && (
          <div className="space-y-6">
            ...
            {/* Store Section */}
            {moreSubTab === "store" && <Store />}

            {/* About Us Section */}
            {moreSubTab === "about" && <About />}
          </div>
        )}
      </main>
