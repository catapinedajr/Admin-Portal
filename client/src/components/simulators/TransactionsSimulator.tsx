                  ...
                  <div className="space-y-3 mb-4">
                    <div className="flex items-center justify-between">
                      <div className={`flex items-center gap-2 ${transactionJourney === "broadcast" ? "text-blue-300" : "text-green-400"}`}>
                        ...
                        <span className="text-base font-medium">Broadcasting to Network</span>
                      </div>
                      {transactionJourney !== "broadcast" && <CheckCircle className="w-5 h-5 text-green-400" />}
                    </div>
                    ...
                    <div className={`flex items-center gap-2 ${transactionJourney === "mempool" ? "text-yellow-300" : transactionJourney === "broadcast" ? "text-zinc-500" : "text-green-400"}`}>
                      ...
                      <span className="text-base font-medium">Mempool Queue</span>
                    ...
                    <div className={`flex items-center gap-2 ${transactionJourney === "confirming" ? "text-yellow-300" : ["broadcast", "mempool"].includes(transactionJourney) ? "text-zinc-500" : "text-green-400"}`}>
                      ...
                      <span className="text-base font-medium">Block Confirmation</span>
                    ...
                    <div className={`flex items-center gap-2 ${transactionJourney === "settled" ? "text-green-400" : "text-zinc-500"}`}>
                      ...
                      <span className="text-base font-medium">Final Settlement</span>
                    </div>
                  </div>
                ...
                <CardContent className="p-3">
                  ...
                  <div className="space-y-1 mb-3">
                    <div className="flex items-center gap-2 text-green-400">
                      ...
                      <span className="text-xs">✓ Broadcast to Network</span>
                    </div>
                    <div className="flex items-center gap-2 text-green-400">
                      <CheckCircle className="w-3 h-3" />
                      <span className="text-xs">✓ Mempool Queue</span>
                    </div>
                    <div className="flex items-center gap-2 text-yellow-300">
                      <Clock className="w-3 h-3 animate-pulse" />
                      <span className="text-xs font-medium">🔄 Block Confirmation ({confirmationCount}/6)</span>
                    </div>
                    <div className="flex items-center gap-2 text-zinc-500">
                      <div className="w-3 h-3 rounded-full bg-zinc-600"></div>
                      <span className="text-xs">Final Settlement</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-6 gap-1">
                      {[...Array(6)].map((_, i) => (
                        <div
                          key={i}
                          className={`h-5 rounded-sm transition-colors flex items-center justify-center text-xs font-bold ${
                            i < confirmationCount 
                    ...
                    {transactionId && (
                      <div className="text-xs text-yellow-200 font-mono bg-yellow-900/30 p-1 rounded break-all">
                        TxID: {transactionId}
                      </div>
                    )}
                    ...
                    <div className="text-xs text-yellow-300 bg-yellow-900/20 p-1 rounded">
              ...
              <Card className="bg-green-900/20 border-green-800">
                <CardContent className="p-3">
                  <div className="text-center mb-3">
                    ...
                    <h5 className="font-bold text-green-300 mb-1 text-lg">Transaction Complete!</h5>
                    <p className="text-green-100 text-xs">Journey complete - {transactionInputs.amount} BTC successfully transferred</p>
                  </div>
                  ...
                  <div className="space-y-1 mb-3">
                    ...
                    <div className="flex items-center gap-2 text-green-400">
                      <CheckCircle className="w-3 h-3" />
                      <span className="text-xs">✓ Block Confirmation (6/6)</span>
                      <span className="text-xs text-green-300 ml-auto">36s</span>
                    </div>
                    <div className="flex items-center gap-2 text-green-400">
                      <CheckCircle className="w-3 h-3" />
                      <span className="text-xs font-medium">✓ Final Settlement</span>
