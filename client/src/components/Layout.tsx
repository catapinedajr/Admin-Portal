...
export default function Layout({ children }: LayoutProps) {
  ...
  // Mock premium status - should be replaced with actual subscription context
  ...
  const getActiveSection = () => {
    ...
    if (location.includes('/simulators')) return 'simulations';
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Bottom Navigation - Exact copy from original */}
      <BottomNavigation 
        activeSection={activeSection}
        onSectionChange={(section) => {
          // Map navigation section names to routes
